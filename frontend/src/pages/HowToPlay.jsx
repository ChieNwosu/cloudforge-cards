...
const steps = [
  ...
  { n: "05", t: "Finish your selected session", d: "Choose 3, 5, or 10 rounds. A final game summary appears after the last round, then you can save your total to the mode-specific leaderboard." },
];
